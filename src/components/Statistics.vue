...
<template>
  <div class="home-container">
    <div class="home-container1">
      <div class="home-master-header">
        <h1 class="home-text">
          <span class="home-text01">Standford University</span>
        </h1>
      </div>
      <div class="home-container2">
        <h1 class="home-text02">
          <span class="home-text03">S</span>
          <span>tanford </span>
          <span class="home-text05">E</span>
          <span class="home-text06"></span>
          <span>ngineering </span>
          <span class="home-text08">E</span>
          <span class="home-text09"></span>
          <span>verywhere</span>
        </h1>
        <h2 class="home-text11">Stanford | engeneering</h2>
      </div>
      <div class="home-menu">
      ...
      <div class="home-content">
        <div class="home-course-details">
          <div class="home-accodiance">
            <span><span class="home-text13">Course Details</span></span>
            <span class="home-text14">Show All</span>
          </div>
       
        <Accordion v-for="(course,index) in courses" 
        :key="index"
        :title="course.title"
        ...
        />
          ...
          <div class="home-accodiance01">
            <span>Course Description</span>
            <span class="home-text16">+</span>
          </div>
          <div class="home-accodiance02">
            <span>Instructor</span>
            <span class="home-text18">+</span>
          </div>
          <div class="home-accodiance03">
            <span>Handouts</span>
            <span class="home-text20">+</span>
          </div>
          <div class="home-accodiance04">
            <span>Resources</span>
            <span class="home-text22">+</span>
          </div>
          <div class="home-accodiance05">
            <span>Assignments</span>
            <span class="home-text24">+</span>
          </div>
        </div>
        <div class="home-course-sessions">
          <div class="home-accodiance06">
            <span class="home-text25">Course Details</span>
            <span class="home-text26"
              ><span class="home-text27">Show All</span></span
            >
          </div>
           <Lecture  v-for="(lecture,index) in lectures" 
           :key="index"
           :lecture= "index +1"
           :topics="lecture.topics"/>
          <div class="home-accodiance07">
   
              
          </div>
          <div class="home-accodiance08">
            <span>Lecture 2</span>
            <span class="home-text31">+</span>
            
          </div>
          <div class="home-accodiance09">
            <span>Lecture 3</span>
            <span class="home-text33">+</span>
          </div>
          <div class="home-accodiance10">
            <span>Lecture 4</span>
            <span class="home-text35">+</span>
          </div>
          <div class="home-accodiance11">
            <span>Lecture 5</span>
            <span class="home-text37">+</span>
          </div>
          <div class="home-accodiance12">
            <span>Lecture 6</span>
            <span class="home-text39">+</span>
          </div>
          <div class="home-accodiance13">
            <span>Lecture 7</span>
            <span class="home-text41">+</span>
          </div>
          <div class="home-accodiance14">
            <span>Lecture 8</span>
            <span class="home-text43">+</span>
          </div>
          <div class="home-accodiance15">
            <span>Lecture 9</span>
            <span class="home-text45">+</span>
          </div>
          <div class="home-accodiance16">
            <span>Lecture 10</span>
            <span class="home-text47">+</span>
          </div>
          <div class="home-accodiance17">
            <span>Lecture 11</span>
            <span class="home-text49">+</span>
          </div>
          <div class="home-accodiance18">
            <span>Lecture 12</span>
            <span class="home-text51">+</span>
          </div>
          <div class="home-accodiance19">
            <span>Lecture 13</span>
            <span class="home-text53">+</span>
          </div>
          <div class="home-accodiance20">
            <span>Lecture 14</span>
            <span class="home-text55">+</span>
          </div>
          <div class="home-accodiance21">
            <span>Lecture 15</span>
            <span class="home-text57">+</span>
          </div>
          <div class="home-accodiance22">
            <span>Lecture 16</span>
            <span class="home-text59">+</span>
          </div>
          <div class="home-accodiance23">
            <span>Lecture 17</span>
            <span class="home-text61">+</span>
          </div>
          <div class="home-accodiance24">
            <span>Lecture 18</span>
            <span class="home-text63">+</span>
          </div>
          <div class="home-accodiance25">
            <span>Lecture 19</span>
            <span class="home-text65">+</span>
          </div>
          <div class="home-accodiance26">
      ...
      <div class="home-footer">
        <div class="home-footer-top">
          <div class="home-footer-top-right">
            <span class="home-text68">Standford |</span>
            <span class="home-text69">
              <span>
                Center
                <span v-html="rawedj0"></span>
              </span>
              <span>for</span>
              <br />
              <span>profestional develpment</span>
            </span>
          </div>
        ...
        <div class="home-footer-bottom">
          <div class="home-footer-bottom-left">
            <span class="home-text75"><span>Standford</span></span>
            <span class="home-text77">University</span>
          </div>
          <div class="home-footer-bottom-right">
            <div class="home-footer-content">
              <span class="home-text78">Stanford Home</span>
              <span class="home-text79">Maps &amp; Directions</span>
              <span class="home-text80">Search Stanford</span>
              <span class="home-text81">Emergency Info</span>
            </div>
            <div class="home-footer-content1">
              <span class="home-text82">Terms of Use</span>
              <span class="home-text83">Privacy</span>
              <span class="home-text84">Copyright</span>
              <span class="home-text85">Trademarks</span>
              <span class="home-text86">Non-Discrimination</span>
              <span class="home-text87">Accessibility</span>
            </div>
            <div class="home-footer-content2">
              <span class="home-text88"
                >© Stanford University, Stanford, California 94305</span
              >
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
        ...
        {
           topics:"The Motivation & Applications of Machine Learning 1",
        },
         {
           topics:"The Motivation & Applications of Machine Learning 2",
        },
         {
           topics:"The Motivation & Applications of Machine Learning 3",
        },
         {
           topics:"The Motivation & Applications of Machine Learning 4",
        },
         {
           topics:"The Motivation & Applications of Machine Learning 5",
        },
        ...
        courses:[
        {
          ...
          description:
            `The course Applied Statistics introduces the basic tools of descriptive and inferential statistical analysis. In this course, we will cover the data-analysis concepts and procedures used in economics,
             business and other social sciences. Emphasis will be given to the manipulation of real data sets to obtain useful and meaningful statistical results, to the qualitative interpretation of such results and to the effective communication in numbers, graphs and words of the insights thus developed. Theory will be combined with data collection and curation, as well as computer lab work with a statistical software package. Students will be encouraged to develop an attitude of mind that accepts uncertainty and variability as part of problem analysis and decision making.

            The only prerequisite for this course is your mathematics courses at high school. The content of this course is covered by the textbook, we will discuss it according to the tentative schedule. There will be homework, quizzes, labs, midterm and final exams.`,
...
.js-badger-accordion.home-course-details.badger-accordion--initialized{
width:100%;

}
.badger-accordion__header .js-badger-accordion-header .badger-accordion-toggle {
    background: rgb(46, 202, 200) !important;
